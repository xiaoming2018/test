...
<form class="layui-form" id="form_test">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="text" name="managerName" required lay-verify="required" value="${Manager.managerName}"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="managerAccount" required lay-verify="required" value="${Manager.managerAccount}"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="managerPassword" required lay-verify="pass" value="${Manager.managerPassword }"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="managerEmail" required lay-verify="email" value="${Manager.managerEmail}"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="managerPhone" required lay-verify="phoneNumber" value="${Manager.managerPhone}"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="hidden" id="pic" name="managerPicture" value="${Manager.managerPicture}" lay-verify="required"/>
            <div class="layui-input-list">
                <img class="layui-upload-img" id="demo1" src="<%=path%>/${Manager.managerPicture}" style="width: 100px;height: 100px">
                <p id="demoText"></p>
                <br>
