...
<form class="layui-form" id="form_test">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="userPhoneNumber" required lay-verify="phoneNumber"
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <input type="text" name="userPassword" required lay-verify="pass"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="hidden" id="pic" name="userPicture" value="" lay-verify="required"/>
