...
function loadObject() {
    ...
    mtlLoader.setPath('webgl_resource/models/mtl/');
    mtlLoader.load('shixiang.mtl', function (materials) {
        materials.preload();
        var objLoader = new THREE.OBJLoader(manager);
        objLoader.setMaterials(materials);
        objLoader.setPath("webgl_resource/models/mtl/");
        objLoader.load('shixiang.obj', function (object) {
