...
function initObject() {
    ...
    loader.load('/ChatRobot/webgl_resource/models/texture/female.jpg', function (image) {
        texture.image = image;
    ...
    loader.load('/ChatRobot/webgl_resource/models/obj/Female.obj', function (object) {
